...
public class Parking implements ParkingFloor {
    ...
    public int unPark(String vehicleNumber, int numberOfHours, ParkingCost parkingCostStrategy) throws InvalidVehicleNumber {
        int costByHours = 0;
        try {
    ...
    private int getCostByHours(int parkHours, ParkingCost parkingCostStrategy) {
